...
public class HttpMailTemplete {
    ...
    public String genHtmlContent(List<BatchResponseBody> list) {
        ...
        taskResult
                ...
                //.append("background:url(E:\javaproject\aotuhome\src\main\webapp\HTML\image\login_home_background.jpg)")
                ...
                .append("<tr class=\"bgth\"><th>用例编号</th><th>用例名称</th><th>预期状态码</th><th>消耗时间(ms)</th><th>是否通过</th></tr>")
